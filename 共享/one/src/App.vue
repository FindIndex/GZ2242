<template>
  <div id="app">
    <nav v-if="this.$route.meta.showNav">
      <router-link to="/">
        <img src="./assets/图标/icon_home.png" alt="">
        <img src="./assets/图标/icon_home_selected.png" alt="">
      </router-link>
      <router-link to="/find">
        <img src="./assets/图标/icon_dicover.png" alt="">
        <img src="./assets/图标/icon_discover_selected.png" alt="">
      </router-link>
      <router-link to="/serialize">
        <img src="./assets/图标/icon_serial.png" alt="">
        <img src="./assets/图标/icon_serial_selected.png" alt="">
      </router-link>
      <router-link to="/mine">
        <img src="./assets/图标/icon_me.png" alt="">
        <img src="./assets/图标/icon_me_selected.png" alt="">
      </router-link>
    </nav>
    <router-view />
    <audio :src=acticle?.json_content?.radio_url autoplay ref="audio" @play="$store.commit('changePlay')"
      @pause="$store.commit('changePlayf')" @durationchange="duration = $event.target.duration"
      @timeupdate="currentTime = $event.target.currentTime"></audio>
    <img class="playbar" @click="showplay=!showplay" src="./assets/图标/float_player_pause.png" alt="">
    <PlayBar v-if="showplay" @change-show="showplay=!showplay" :title="acticle?.json_content?.title"
      :currentTime="currentTime" :duration="duration" @update-time="updatetime"
      :author="acticle?.author_list[0]?.user_name" :acticle="acticle" />
  </div>
</template>
<script>
...
export default {
  ...
  data() {
    return {
      ...
      currentTime: 0,
      showplay: false,
      // JSON.parse(window.localStorage.getItem("acticle") || {} )
      acticle: JSON.parse(window.localStorage.getItem("acticle") || {}),
      // author:"",
    }
  },
  methods: {
    ...
    getsong(id) {
      this.axios
        ...
        .then((res) => {
          // this.song = res.data.data.json_content.radio_url
          this.acticle = res.data.data
          // this.author = res.data.data.author_list[0].user_name
        })
    },
    updatetime(time) {
  ...
  watch: {
    ...
    "$store.state.playingD"() {
      // console.log(this.$store.state.playingD);
      this.getsong(this.$store.state.playingD)
    },
    acticle() {
      window.localStorage.setItem("acticle", JSON.stringify(this.acticle))
    }
  }
}
</script>
...
#app {
  ...
  //   font-weight: 200;
  //   src: url("//at.alicdn.com/wf/webfont/aD3GV1XzgT5Y/MIo2M7jWQD7ETRbvGLuvO.woff2") format("woff2"),
  //     url("//at.alicdn.com/wf/webfont/aD3GV1XzgT5Y/akRcfAnZi08Th_0DzuNHs.woff") format("woff");
  //   font-display: swap;
  // }
  .playbar {
    width: 50rem;
...
.one-icon-addedtolist:before {
  content: "\e621";
}

.one-icon-addtolist:before {
  content: "\e622";
}

.one-icon-back:before {
  content: "\e623";
}

.one-icon-chapter:before {
  content: "\e624";
}

.one-icon-close:before {
  content: "\e625";
}

.one-icon-camera:before {
  content: "\e626";
}

.one-icon-download:before {
  content: "\e627";
}

.one-icon-dilmed:before {
  content: "\e628";
}
...
.one-icon-comment:before {
  content: "\e62a";
}

.one-icon-feedback:before {
  content: "\e62b";
}

.one-icon-film:before {
  content: "\e62c";
}

.one-icon-filminfo:before {
  content: "\e62d";
}

.one-icon-following:before {
  content: "\e630";
}

.one-icon-imagetext:before {
  content: "\e631";
}

.one-icon-last:before {
  content: "\e632";
}

.one-icon-image:before {
  content: "\e633";
}

.one-icon-info:before {
  content: "\e634";
}

.one-icon-liked:before {
  content: "\e635";
}

.one-icon-looplist:before {
  content: "\e636";
}

.one-icon-looptrack:before {
  content: "\e637";
}

.one-icon-like:before {
  content: "\e638";
}
...
.one-icon-more:before {
  content: "\e63a";
}

.one-icon-next:before {
  content: "\e63b";
}

.one-icon-music:before {
  content: "\e63c";
}

.one-icon-musicinfo:before {
  content: "\e63d";
}

.one-icon-musiced:before {
  content: "\e63e";
}

.one-icon-pause:before {
  content: "\e63f";
}

.one-icon-pausewithcircle:before {
  content: "\e688";
}

.one-icon-note:before {
  content: "\e640";
}

.one-icon-noghtmode:before {
  content: "\e641";
}

.one-icon-play:before {
  content: "\e642";
}

.one-icon-playwithcircle:before {
  content: "\e689";
}
...
.one-icon-readed:before {
  content: "\e646";
}

.one-icon-share:before {
  content: "\e648";
}

.one-icon-setting:before {
  content: "\e649";
}

.one-icon-thumb:before {
  content: "\e64b";
}

.one-icon-thumbed:before {
  content: "\e64c";
}

.one-icon-orderplay:before {
  content: "\e658";
}

.one-icon-voice:before {
  content: "\e659";
}

.one-icon-next1:before {
  content: "\e65a";
}

.one-icon-menu:before {
  content: "\e65b";
}

.one-icon-message:before {
  content: "\e65c";
}

.one-icon-collect:before {
  content: "\e65d";
}

.one-icon-collected:before {
  content: "\e65e";
}

.one-icon-icon-test:before {
  content: "\e65f";
}

.one-icon-icon-test1:before {
  content: "\e660";
}

.one-icon-icon-test2:before {
  content: "\e661";
}

.one-icon-icon-test3:before {
  content: "\e662";
}

.one-icon-icon-test4:before {
  content: "\e663";
}

.one-icon-icon-test5:before {
  content: "\e664";
}

.one-icon-icon-test6:before {
  content: "\e665";
}

.one-icon-icon-test7:before {
  content: "\e666";
}

.one-icon-icon-test8:before {
  content: "\e667";
}

.one-icon-point:before {
  content: "\e668";
}

.one-icon-icon-test9:before {
  content: "\e669";
}
...
.one-icon-letter_j:before {
  content: "\e680";
}

.one-icon-letter_n:before {
  content: "\e681";
}

.one-icon-letter_s:before {
  content: "\e682";
}

.one-icon-letter_t:before {
  content: "\e683";
}

.one-icon-read1:before {
  content: "\e684";
}

.one-icon-reading:before {
  content: "\e685";
}
...
nav {
  ...
  border-top: 1rem solid rgba(209, 208, 208, 0.666);
